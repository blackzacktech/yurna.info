...
import { ExcludedEvents } from "@yurna/util/database";
import { getGuildFromMemberGuilds, getGuild, getGuildChannels } from "@yurna/util/functions/guild";
...
export default async function LogsPage(props: { params: Promise<{ server: string }> }) {
 ...
 return (
  <>
   ...
   <p className="mb-4 text-left text-base md:text-lg">Manage the actions that Yurna.info can watch and log in selected channels.</p>
