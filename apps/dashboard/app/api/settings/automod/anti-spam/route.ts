...
export async function POST(request: NextRequest) {
 try {
   ...
   data.actions = [
    {
     ...
     metadata: {
      custom_message: "Message blocked due to detected spam. Rule added by Yurna.info",
     },
    },
   ];
  }
  ...
  const validatedActions = await validateAutoModRuleActions(data.actions, guildChannels, "Message blocked due to detected spam. Rule added by Yurna.info");
