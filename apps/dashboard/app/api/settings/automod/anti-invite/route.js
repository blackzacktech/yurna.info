...
import { createHTTPAutomodRule, validateAutoModIgnores, validateAutoModRuleActions } from "@yurna/util/functions/automod";
import { getServer, getGuildMember } from "@yurna/util/functions/guild";
...
export async function POST(request) {
 try {
  ...
  const validatedActions = await validateAutoModRuleActions(data.actions, allChannels, "Message blocked due to containing an invite link. Rule added by Yurna.info");
