import { dashboardConfig, globalConfig } from "@yurna/config";
import prismaClient from "@yurna/database";
import { GuildLogType } from "@yurna/database/types";
import { pseudoRandom } from "@yurna/util/functions/util";
...
export const metadata: Metadata = {
 title: "Yurna.info - The only one Discord Bot",
 description: "Yurna.info will not only keep your server entertained but also assist you with moderation and many other things!",
};
...
export default async function Page() {
 const exampleLogs = [
  ...
  },
  {
   ...
   content: "Changed vanity URL to /yurna",
   data: {},
   user: {
  ...
  <div className="p-6">
   <div className="relative z-20 flex min-h-screen w-full items-center justify-center">
    ...
    <div className="relative z-20 -mt-8 flex w-full select-none flex-col items-center justify-center gap-4 px-3 md:w-[90%]">
     ...
     >
      <Link href="/api/invite" className={cn("group rounded-full border flex transition-all ease-in hover:cursor-pointer  border-neutral-800 bg-neutral-900 hover:border-neutral-700 hover:bg-neutral-800")}>
       <AnimatedShinyText className="inline-flex items-center justify-center px-4 py-1 transition ease-out hover:text-neutral-400 hover:duration-300">
        <span>✨ Introducing Yurna.info</span>
     ...
     >
      <Header className={cn(headerVariants({ variant: "h2", alignment: "center" }), "max-w-[680px] font-normal text-white/70")}>Yurna.info will not only keep your server entertained but also assist you with moderation and many other things!</Header>
     </Fade>
     <Fade
      framerProps={{
    ...
    <div className="mx-auto mb-32 max-w-[1400px] md:px-8 lg:px-16">
     ...
     <div className="mx-auto flex w-full max-w-[1400px] flex-col gap-4 px-4 md:grid md:grid-cols-2 md:px-0 lg:grid-cols-3">
       ...
       <div className="mt-3">
        <div className="flex flex-row items-center gap-1">
         ...
         <span className="text-xs">
          <span className="font-bold">Yurna.info</span> used <span className="font-bold text-accent-primary">/ai</span>
         </span>
        </div>
      ...
      <div className="row-span-1 overflow-hidden rounded-xl border border-neutral-800 bg-background-secondary p-4 duration-200 hover:bg-neutral-800/50">
       ...
       <p className="mt-2 max-w-[680px] text-white/70">Yurna.info has a leveling system that will keep your members active and entertained.</p>
       <LevelUp avatar={dashboardConfig.logo} username="Yurna.info" />
      </div>
      <div className="relative col-span-2 row-span-2 overflow-hidden rounded-xl border border-neutral-800 bg-background-secondary px-8 py-6 duration-200 hover:bg-neutral-800/50 lg:col-span-1">
       ...
       <div className="relative z-10">
        <p className="mt-2 max-w-[680px] text-white/70">
         <Balancer>Someone's breaking the rules? You can easily enable Auto-Moderation and Yurna.info will take care of the rest!</Balancer>
        </p>
       ...
       <div className="relative z-50 h-full">
        <div className="px-8 py-6">
         ...
         <p className="max-w-[680px] text-white/70">
          <Balancer>With Yurna.info you can get to know your server better with the help of the dashboard. You can see the most active members, the most used channels and activity graphs!</Balancer>
         </p>
        </div>
      ...
      <div className="relative col-span-2 row-span-1 overflow-hidden rounded-xl border border-neutral-800 bg-background-secondary px-8 py-6 pb-2 duration-200 hover:bg-neutral-800/50 lg:col-span-1">
       ...
       <p className="mt-2 max-w-[680px] text-white/70">Want to host a giveaway or a drop? Yurna.info can help you with that! You can easily create and moderate giveaways with few simple commands!</p>
    ...
    <div className="mx-auto mb-32 max-w-[1400px] md:px-8 lg:px-16">
     <div className="mx-auto my-16 flex flex-col gap-8 px-4 lg:flex-row lg:gap-16 lg:px-0">
      <div className="flex w-full flex-col justify-center gap-2 lg:w-2/5">
       ...
       <p className="text-white/70">With Yurna.info you can see your server statistics in real-time. You can see the most active members, the most used channels and much more!</p>
      </div>
     ...
     <div className="mx-auto my-16 flex flex-col-reverse gap-8 px-4 lg:flex-row lg:gap-16 lg:px-0">
      ...
      <div className="flex w-full flex-col justify-center gap-2 lg:w-2/5">
       ...
       <p className="text-white/70">Yurna.info has a powerful logging system that will keep track of everything that happens in your server. You can easily see who did what and when!</p>
      </div>
     </div>
     ...
     <div className="mx-auto my-16 flex flex-col gap-8 px-4 lg:flex-row lg:gap-16 lg:px-0">
      <div className="flex w-full flex-col justify-center gap-2 lg:w-2/5">
       ...
       <p className="text-white/70">Yurna.info with its many features can replace many bots on your server. You can have moderation, leveling, image manipulation and much more in one bot!</p>
      </div>
    ...
    <div className="relative mx-auto mt-32 h-[600px] max-w-6xl overflow-hidden rounded-3xl border border-neutral-800 bg-transparent pb-10 shadow-2xl md:px-8 lg:px-16">
     <div className="flex flex-col items-center justify-center pt-20">
      ...
      <p className="mb-6 w-full text-center text-lg text-neutral-300">
       <Balancer>Don't wait ages to add Yurna.info to your server! Invite it now and see it in action!</Balancer>
      </p>
