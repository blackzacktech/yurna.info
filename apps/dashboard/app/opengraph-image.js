...
export const alt = "Yurna.info - The only one Discord Bot";
 ...
 return new ImageResponse(
  (
   ...
   >
    ...
    >
     Yurna.info will not only keep your server entertained but also assist you with moderation and many other things!
    </div>
   </div>
  ),
  {
