 ...
 return (
  <div className="flex w-full flex-col items-center px-8 pb-8 pt-16 antialiased md:p-16">
   <div className="flex flex-col justify-center gap-4">
    <Image src={dashboardConfig.logo} alt="Yurna.info logo" quality={100} width={112} height={112} className="mx-auto size-28 shrink-0 rounded-full" />
    <Header className={cn(headerVariants({ variant: "h1", alignment: "center", effects: "gradient" }))}>Yurna.info Commands</Header>
