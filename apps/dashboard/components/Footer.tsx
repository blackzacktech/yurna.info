    ...
    <div className="grid grid-cols-2 gap-9 md:grid-cols-5">
     <div className="col-span-3 flex flex-col justify-center">
      ...
      {!process.env.NEXT_PUBLIC_IS_HOSTED_BY_CREATOR ? (
       <div className="mt-3 text-neutral-300">
        <Link target="_blank" href="https://yurna.info" className="font-semibold text-accent-primary hover:opacity-80">
        ...
        <div className="mt-2">
         ...
         .
         <Link className={cn(buttonVariants({ variant: "primary" }), "mt-3 w-fit")} href="https://yurna.info/invite">
     ...
     <div className="col-span-1 text-neutral-300">
      ...
      <div>
       ...
       <Link href="https://github.com/igorkowalczyk/yurna.exe" className="mt-2 block duration-100 hover:text-gray-300 hover:underline motion-reduce:transition-none">
        Source code
       </Link>
      </div>
     </div>
