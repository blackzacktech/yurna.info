   ...
   <div className="mx-auto pt-10">
    <div className="grid grid-cols-2 gap-9 md:grid-cols-5">
     <div className="col-span-3 flex flex-col justify-center">
      ...
      {!process.env.NEXT_PUBLIC_IS_HOSTED_BY_CREATOR ? (
       <div className="mt-3 text-neutral-300">
        <Link target="_blank" href="https://yurna.info" className="text-accent-primary font-semibold hover:opacity-80">
         🔥 Powered by Yurna.info!
        </Link>
        <div className="mt-2">
         This is a public instance of Yurna.info - a free and open-source Discord bot. You can invite it to your server by clicking on the button below or{" "}
         <Link href="https://yurna.info/invite" className="font-semibold text-neutral-200 hover:underline">
          by clicking here
         </Link>
         .
         <ButtonPrimary className="mt-3 w-fit" href="https://yurna.info/invite">
          <Icons.sparkles className="mr-2 h-5 w-5" />
          Invite original Yurna.info
         </ButtonPrimary>
        </div>
       </div>
      ) : (
     ...
     <div className="col-span-1 text-neutral-300">
      ...
      <div>
       ...
       <Link href="https://github.com/blackzacktech/yurna.info" className="mt-2 block duration-100 hover:text-gray-300 hover:underline motion-reduce:transition-none">
        Source code
       </Link>
      </div>
     </div>
    ...
    <div className="mt-5 flex text-center text-neutral-300">
     ...
     <p className="text-sm font-semibold opacity-80">
      ...
      <Link className="hover:opacity-80" href="https://blackzacktech.dev">
       Blackzack-Tech
      </Link>
      , All rights reserved.
     </p>
