...
export async function uploadEmoji(clientId: string, client: Yurnabot, { name, image }: { name: string; image: Buffer }): Promise<void> {
 try {
...
export default async function loadEmojis(client: Yurnabot): Promise<void> {
 try {
