...
export async function enableAntiLink(client: Yurnabot, interaction: ChatInputCommandInteraction, guildSettings: GuildSettings) {
   ...
   actions: [
    {
     ...
     metadata: {
      ...
      customMessage: "Message blocked due to containing an link. Rule added by Yurna.info",
     },
    },
   ],
