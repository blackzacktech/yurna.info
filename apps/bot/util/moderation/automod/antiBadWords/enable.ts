...
export async function enableAntiBadWords(client: Yurnabot, interaction: ChatInputCommandInteraction, guildSettings: GuildSettings) {
 ...
 if (createdRule) {
  ...
  const ruleToCreate = {
   name: "Anti bad words [Yurna.info]",
   ...
   actions: [
    {
     ...
     metadata: {
      ...
      customMessage: "Message blocked due to containing a bad word. Rule added by Yurna.info",
     },
    },
   ],
