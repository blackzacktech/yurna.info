import { syncDatabaseAutoModRule } from "@yurna/util/database";
import { ChatInputCommandInteraction, EmbedBuilder } from "discord.js";
import type { Yurnabot } from "@/index";
import type { GuildSettings } from "@/util/types/Command";

export async function disableAntiBadWords(client: Yurnabot, interaction: ChatInputCommandInteraction, guildSettings: GuildSettings) {
