...
export async function enableAntiSpam(client: Yurnabot, interaction: ChatInputCommandInteraction, guildSettings: GuildSettings) {
   ...
   actions: [
    {
     ...
     metadata: {
      ...
      customMessage: "Message blocked due to detected spam. Rule added by Yurna.info",
     },
    },
   ],
