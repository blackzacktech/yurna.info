import { createDatabaseAutoModRule, syncDatabaseAutoModRule } from "@yurna/util/database";
...
export async function enableAntiInvite(client: Yurnabot, interaction: ChatInputCommandInteraction, guildSettings: GuildSettings) {
   ...
   actions: [
    {
     ...
     metadata: {
      ...
      customMessage: "Message blocked due to containing an invite link. Rule added by Yurna.info",
     },
    },
   ],
