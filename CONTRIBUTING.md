![Header](![Header](./docs/assets/Yurna_Banner.png?raw=true)
...
<!-- prettier-ignore -->
> [!NOTE]
> If you are reading this, **you are probably interested in contributing to yurna.info**. **We appreciate your interest** in improving the project and welcome your contributions. To ensure a smooth and productive collaboration, **please review the following guidelines.**

<!-- prettier-ignore-end -->

## 🆕 Submitting Contributions

We know that contributing to a project can be intimidating, especially if you are new to the community. However, we want to assure you that **contributing to yurna.info is easy and fun**.
...
![Forking blackzacktech/yurna.info repository on Github](./docs/assets/forking.png)
...
```bash
git clone https://github.com/your-username/yurna.info.git
cd yurna.info
```

This creates a local copy of your forked repository on your computer in directory `yurna.info`.
...
```bash
git remote add upstream https://github.com/blackzacktech/yurna.info
git remote -v
```
...
> [!IMPORTANT]
> Remember to test your changes before submitting them! **You can read the [README.md](https://github.com/blackzacktech/yurna.info/blob/master/README.md) file for instructions on how to set up the project locally.**
...
Want to contribute to yurna.info but don't know where to start? **Join our community!** We have created a welcoming community that encourages collaboration and supports new contributors. **We are excited to have you on board!** 🙌

[We created a Discord server for the yurna.info community.](https://blackzacktech.dev/discord) **Join the server to connect with fellow contributors and get support from the project maintainers.** We look forward to collaborating with you! 🚀👾🙌

[![Join the Discord server](https://blackzacktech.dev/discord)](https://blackzacktech.dev/discord)
...
You can contact the project maintainers by [joining the Discord server](https://blackzacktech.dev/discord) or [opening an issue](https://github.com/blackzacktech/yurna.info/issues/new/choose) on GitHub.

[![Create a new issue on GitHub](./docs/assets/feedback.png)](./docs/assets/feedback.png)

### Spread the Word 📢

**Help us spread the word about yurna.info!** We would love to see more people join our community and contribute to the project. **Please share the project with your friends and colleagues.** We appreciate your support! 🙌

**Thank you for your valuable contributions, and we look forward to collaborating with you on the yurna.info project! 🚀👾🙌**
